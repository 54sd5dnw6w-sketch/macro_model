...
h.session_init(running = False, pi_prev = None, first_iteration =  True, iter_counter = 0,
               iteration_df = pd.DataFrame([
                   {"Iteration": -2, "Output": 1, "Inflation": 0},
                   {"Iteration": -1, "Output": 1, "Inflation": 0},
               ]))
...
def clear():
    ...
    st.session_state.iteration_df = pd.DataFrame([
        {"Iteration": -2, "Output": 1, "Inflation": 0},
        {"Iteration": -1, "Output": 1, "Inflation": 0},
    ])
...
with st.container():
    ...
    with cols[1].container(border=True):
        ...
        st.session_state.iteration_df.loc[st.session_state.iteration_df["Iteration"] == -1, "Inflation"] = pi
        st.session_state.iteration_df.loc[st.session_state.iteration_df["Iteration"] == -2, "Inflation"] = pi
